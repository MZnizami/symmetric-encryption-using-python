...
"padding:3px;")
        ...
        #############################################
        self.encrypt.clicked.connect(self.encryptColumnar)
        ##############################################
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptColumnar)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Columnar Cipher"))
