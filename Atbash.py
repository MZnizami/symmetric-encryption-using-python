...
class Ui_Dialog(object):
    ...
    def encryptAtbash(self):
        plaintext = self.plainText.toPlainText().upper()
    ...
    def decryptAtbash(self):
        ...
        plaintext = ""
        if(ciphertext==""):
            self.decryptResult.setText("Field is empty!")
            self.cipheredTextField.setPlainText("")
        else:
            for letter in ciphertext:
                plaintext += lookup_table[letter]
...
"padding:3px;")
        ...
        self.encrypt.clicked.connect(self.encryptAtbash)
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptAtbash)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Atbash Cipher"))
