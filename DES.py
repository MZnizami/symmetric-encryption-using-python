...
class Ui_Dialog(object):
    ...
    def encryptDES(self):
        ...
        if(text==""):
            ...
            self.showCipheredText.setText("Key length must be 8 bytes!")
            ...
            print(str(ciphertext.hex()))
            self.showCipheredText.setText(str(ciphertext.hex()))
    ...
    def decryptDES(self):
        ...
        if(ciphertext==""):
            ...
            self.decryptResult.setText("Key length must be 8 bytes!")
            ...
            print(str(plaintext))
            self.decryptResult.setText(str(plaintext))
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(340, 60, 111, 41))
...
"")
        ...
        self.encrypt.setGeometry(QtCore.QRect(350, 260, 101, 31))
...
"padding:3px;")
        ...
        self.encrypt.clicked.connect(self.encryptDES)
        self.plainText = QtWidgets.QPlainTextEdit(Dialog)
        self.plainText.setGeometry(QtCore.QRect(140, 120, 501, 61))
        self.plainText.setObjectName("plainText")
        self.keyPlain = QtWidgets.QPlainTextEdit(Dialog)
        self.keyPlain.setGeometry(QtCore.QRect(140, 190, 501, 61))
        ...
        self.showCipheredText.setGeometry(QtCore.QRect(140, 310, 501, 91))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.cipheredTextField.setGeometry(QtCore.QRect(140, 480, 511, 61))
        self.cipheredTextField.setObjectName("cipheredTextField")
        self.cipheredKey = QtWidgets.QPlainTextEdit(Dialog)
        self.cipheredKey.setGeometry(QtCore.QRect(140, 550, 511, 61))
        self.cipheredKey.setObjectName("cipheredKey")
        self.label_8 = QtWidgets.QLabel(Dialog)
        self.label_8.setGeometry(QtCore.QRect(350, 420, 121, 41))
        ...
        self.decrypt.setGeometry(QtCore.QRect(330, 620, 111, 31))
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptDES)
        self.decryptResult = QtWidgets.QLabel(Dialog)
        self.decryptResult.setGeometry(QtCore.QRect(140, 680, 511, 91))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_13.setGeometry(QtCore.QRect(660, 120, 111, 121))
        self.label_13.setStyleSheet("border-image: url(:/newPrefix/lock (2).png);")
        self.label_13.setText("")
        self.label_13.setObjectName("label_13")
        self.label_14 = QtWidgets.QLabel(Dialog)
        self.label_14.setGeometry(QtCore.QRect(670, 470, 81, 131))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "DES Cipher"))
