...
class Ui_Dialog(object):
    ...
    def encryptBifid(self):
        ...
        if(plaintext=="" or key == ""):
            ...
            ciphertext= encipher_bifid5(plaintext, key)
            self.showCipheredText.setText(ciphertext)

    def decryptBifid(self):
        ...
        if(ciphertext=="" or key == ""):
            ...
            plaintext= decipher_bifid5(ciphertext, key)
...
"padding:3px;")
        ...
        #############################################
        self.encrypt.clicked.connect(self.encryptBifid)
        ##############################################
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptBifid)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Bifid Cipher"))
