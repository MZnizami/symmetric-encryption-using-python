    ...
    def encryptReverse(self):
        ...
        if(plaintext==""):
            ...
            for c in range(i, -1, -1):
                ciphertext = ciphertext + plaintext[c]
            txt = "Cipher"
            print(txt[::-1])
            self.showCipheredText.setText(ciphertext)
    def decryptReverse(self):
        ...
        if(ciphertext==""):
            ...
            for p in range(i,-1, -1):
                plaintext = plaintext +ciphertext[p]
...
"background-color: rgb(34, 51, 99);")
        ...
        self.label_2.setGeometry(QtCore.QRect(190, 10, 211, 31))
...
"padding:3px;")
        ...
        ##################################################
        self.encrypt.clicked.connect(self.encryptReverse)
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptReverse)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Reverse Cipher"))
