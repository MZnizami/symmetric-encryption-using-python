...
"padding:3px;")
        ...
        ########################################
        self.encrypt.clicked.connect(self.encryptTwoSquare)
...
"padding:10px;")
        ...
        #############################################
        self.decrypt.clicked.connect(self.decryptTwoSquare)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Two-Square Cipher"))
