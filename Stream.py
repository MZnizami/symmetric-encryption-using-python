...
class Ui_Dialog(object):
    ...
    def encryptStream(self):
        ...
        if(plaintext=="" or key == ""):
            ...
            self.showCipheredText.setText("Key and message must be of the same length!")
            self.plainText.setPlainText("")
            self.keyPlain.setPlainText("")
        else:
            for i in plaintext:
                cipher = (ord(i) ^ ord(key[index]))
                index = index + 1
            cipher = str(chr(cipher))
            self.showCipheredText.setText(cipher


)
    def decryptStream(self):
        ...
        if(ciphertext=="" or key == ""):
            ...
            self.decryptResult.setText("Key and message must be of the same length!")
            self.cipheredKey.setPlainText("")
            self.cipheredTextField.setPlainText("")
        else:
            for i in ciphertext:
                plaintext = ord(i) ^ ord(key[index])
...
"padding:3px;")
        ...
        #############################################
        self.encrypt.clicked.connect(self.encryptStream)
        ##############################################
        ...
        self.showCipheredText.setStyleSheet("font: 10pt \"Agency FB\";\n"
"\n"
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Stream Cipher"))
