...
class Ui_Dialog(object):
    ...
    def encryptADFGVX(self):
        machine = self.definecm()
    ...
    def decryptADFGVX(self):
        ...
        if(ciphertext=="" or key == ""):
            ...
            machine.set_key(key)
            dec = machine.decrypt(ciphertext)
...
"padding:3px;")
        ...
        #############################################
        self.encrypt.clicked.connect(self.encryptADFGVX)
        ##############################################
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptADFGVX)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "ADFGVX Cipher"))
