    ...
    def encryptPolybius(self):
        ...
        if(plaintext==""):
            ...
            for char in plaintext:
                ...
                r = str(row)
                c = str(col)
                ciphertext = ciphertext + r+ c  +" "
            self.showCipheredText.setText(ciphertext)
    def decryptPolybius(self):
...
"padding:3px;")
        ...
        self.encrypt.clicked.connect(self.encryptPolybius)
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptPolybius)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Polybius Cipher"))
