...
class Ui_Dialog(object):
    ...
    def decryptADFGX(self):
        ...
        if(ciphertext=="" or key == ""):
            ...
            dec = cipher.decrypt(ciphertext, key, alphabet)
...
"padding:3px;")
        ...
        #############################################
        self.encrypt.clicked.connect(self.encryptADFGX)
        ##############################################
...
"padding:10px;")
        ...
        self.decrypt.clicked.connect(self.decryptADFGX)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "ADFGX Cipher"))
